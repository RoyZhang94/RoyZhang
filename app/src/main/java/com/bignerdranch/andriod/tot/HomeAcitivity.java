...
public class HomeAcitivity extends FragmentActivity implements  OnClickListener {
    ...
    private void initView() {
        ...
        findViewById(R.id.main_navi_recommend).setOnClickListener(this);
        findViewById(R.id.main_navi_mine).setOnClickListener(this);
        fragments = new ArrayList<Fragment>();
        fragments.add(new TabLayoutWithViewPagerFragment());
        fragments.add(new RecommenedFragment());
        fragments.add(new MineFragment());

        PagerAdapter pagerAdapter = new FragmentPagerAdapter(this.getSupportFragmentManager()) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.main_navi_home:
                ...
                break;
            case R.id.main_navi_recommend:
                pager.setCurrentItem(1,true);
                break;
            case R.id.main_navi_mine:
...
//                break;
//            case 1:
//                radioGroup.check(R.id.main_navi_recommend);
//                break;
//            case 2:
//                radioGroup.check(R.id.main_navi_mine);
//            default:
//                break;
//        }
//
